...
exports.MODEL_METADATA_REGISTRY = exports.DEFAULT_MODEL_METADATA = void 0;
exports.getModelMetadata = getModelMetadata;
exports.getModelMetadataFromPatterns = getModelMetadataFromPatterns;
exports.isLLMModel = isLLMModel;
 ...
 */
exports.DEFAULT_MODEL_METADATA = {
    maxInputTokens: 8192,
...
const md = (maxInputTokens, maxOutputTokens, supportsToolCalling, supportsImageInput, modelType = 'llm') => ({
    maxInputTokens,
    maxOutputTokens,
    supportsToolCalling,
    supportsImageInput,
...
function getModelMetadata(modelId) {
    ...
    return exports.DEFAULT_MODEL_METADATA;
}
/**
 ...
 */
exports.MODEL_METADATA_REGISTRY = {
